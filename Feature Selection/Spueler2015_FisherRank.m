...
% % Saving features
% save("Spueler2015_Combo", "d_m", "d_med", "d_all", "d_up", "d_low", "d_max", "d_min", "d_v")
...
title('Spueler 2015 Log Fisher Rank');
ylim([-10,0])
grid on
legend('Grand Average Temporal Log Fisher Scores', 'Overall Temporal Log Fisher Scores')
% saveas(gcf,'2015_videogame/Combination/LogFisherRank.png')