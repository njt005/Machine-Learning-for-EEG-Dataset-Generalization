...
% % Saving features
% save("Ehrlich2018_Combo", "d_m", "d_med", "d_all", "d_up", "d_low", "d_min", "d_max", "d_v")
...
title('Ehrlich 2018 Log Fisher Rank');
ylim([-8,0])
grid on
legend('Grand Average Temporal Log Fisher Scores', 'Overall Temporal Log Fisher Scores')
% saveas(gcf,'delayedCursor2018/Combination/LogFisherRank.png')