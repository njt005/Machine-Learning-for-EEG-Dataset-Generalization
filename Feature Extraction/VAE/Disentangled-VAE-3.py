...
class VAE(nn.Module):
    ...
    def __init__(self, zdims):
        ...
        self.decoder = nn.Sequential(
            ...
            # deconv layer 4
            nn.ConvTranspose2d(64, CHAN, 4, 2, 1),
            nn.Sigmoid()

        )
        
        # conv fc
        self.fc11 = nn.Linear(256, self.zdims) # mu
        self.fc12 = nn.Linear(256, self.zdims) # logvar
        
        # deconv fc
        self.fc2 = nn.Linear(self.zdims, 256)
    ...
    def decode(self, z):
        ...
        deconv_input = deconv_input.view(-1, 64, 4, 4)
