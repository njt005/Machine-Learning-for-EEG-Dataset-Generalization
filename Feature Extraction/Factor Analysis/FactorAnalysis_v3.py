...
def feature_extraction():
    ...
    plt.title('Initial Mean Training Feature Vector (Cz)')
    plt.ylabel('Cz')
    plt.xlabel('Temporal Features')
    plt.yticks([])
    fig.colorbar(im, fraction=0.046, pad=0.04)
    plt.show()

    fig, ax = plt.subplots()
    plt.title('Initial Mean Testing Feature Vector (Cz)')
    ...
    plt.title('Transformed Mean Training Feature Vector (Cz)')
    plt.ylabel('Cz')
    plt.xlabel('Temporal Features')
    plt.yticks([])
    fig.colorbar(im, fraction=0.046, pad=0.04)
    ...
    plt.title('Transformed Mean Testing Feature Vector (Cz)')
    plt.ylabel('Cz')
    plt.xlabel('Temporal Features')
    plt.yticks([])
    fig.colorbar(im, fraction=0.046, pad=0.04)
